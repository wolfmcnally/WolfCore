...
SWIFT_MODULE_NAMESPACE_PUSH("WolfBase")
...
SWIFT_CLASS("_TtC8WolfBase11HTTPActions")
@interface HTTPActions : NSObject <NSURLSessionDataDelegate>
...
- (void)URLSession:(NSURLSession * _Nonnull)session dataTask:(NSURLSessionDataTask * _Nonnull)dataTask didReceiveData:(NSData * _Nonnull)newData;
