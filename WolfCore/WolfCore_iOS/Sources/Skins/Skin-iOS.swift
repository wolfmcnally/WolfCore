...
extension UIStatusBarStyle: SkinValue {
  public func interpolated(to other: UIStatusBarStyle, at frac: Frac) -> UIStatusBarStyle {
...
extension SkinKey {
  ...
  public static let statusBarStyle = SkinKey("statusBarStyle")
  public static let navigationBarHidden = SkinKey("navigationBarHidden")
  ...
  public static let barbuttonTitleStyle = SkinKey("barbuttonTitleStyle")
  ...
  public static let segbarBarColor = SkinKey("segbarBarColor")
  public static let segbarItemColor = SkinKey("segbarItemColor")
  public static let segbarTintColor = SkinKey("segbarTintColor")
  ...
  public static let sliderThumbColor = SkinKey("sliderThumbColor")
  public static let sliderMinTrackColor = SkinKey("sliderMinTrackColor")
  public static let sliderMaxTrackColor = SkinKey("sliderMaxTrackColor")

  public static let bannerBarBackgroundColor = SkinKey("bannerBarBackgroundColor")
  public static let bannerStatusBarStyle = SkinKey("bannerStatusBarStyle")

  public static let bulletinBackgroundColor = SkinKey("bulletinBackgroundColor")
  public static let bulletinTitleStyle = SkinKey("bulletinTitleStyle")
  public static let bulletinMessageStyle = SkinKey("bulletinMessageStyle")
}

extension Skin {
  public var statusBarStyle: UIStatusBarStyle {
    get { return get(.statusBarStyle, .default) }
    set { set(.statusBarStyle, to: newValue) }
  }
  public var navigationBarHidden: Bool {
    get { return get(.navigationBarHidden, false) }
    set { set(.navigationBarHidden, to: newValue) }
  }
  ...
  public var barbuttonTitleStyle: FontStyle {
    get { return get(.barbuttonTitleStyle, FontStyle(.barbuttonTitleStyle, font: .systemFont(ofSize: 16))) }
    set { set(.barbuttonTitleStyle, to: newValue) }
  }
  ...
  public var segbarBarColor: Color {
    get { return get(.segbarBarColor, topbarColor) }
    set { set(.segbarBarColor, to: newValue) }
  }
  public var segbarItemColor: Color {
    get { return get(.segbarItemColor, topbarTitleColor) }
    set { set(.segbarItemColor, to: newValue) }
  }
  public var segbarTintColor: Color {
    get { return get(.segbarTintColor, topbarTintColor) }
    set { set(.segbarTintColor, to: newValue) }
  }
  ...
  public var sliderThumbColor: Color {
    get { return get(.sliderThumbColor, tintColor) }
    set { set(.sliderThumbColor, to: newValue) }
  }
  public var sliderMinTrackColor: Color {
    get { return get(.sliderMinTrackColor, .lightGray) }
    set { set(.sliderMinTrackColor, to: newValue) }
  }
  public var sliderMaxTrackColor: Color {
    get { return get(.sliderMaxTrackColor, .darkGray) }
    set { set(.sliderMaxTrackColor, to: newValue) }
  }

  public var bannerBarBackgroundColor: Color {
    get { return get(.bannerBarBackgroundColor, Color(white: 0.2, alpha: 1.0)) }
    set { set(.bannerBarBackgroundColor, to: newValue) }
  }
  public var bannerStatusBarStyle: UIStatusBarStyle {
    get { return get(.bannerStatusBarStyle, .lightContent) }
    set { set(.bannerStatusBarStyle, to: newValue) }
  }

  public var bulletinBackgroundColor: Color {
    get { return get(.bulletinBackgroundColor, .gray) }
    set { set(.bulletinBackgroundColor, to: newValue) }
  }
  public var bulletinTitleStyle: FontStyle {
    get { return get(.bulletinTitleStyle, FontStyle(.bulletinTitleStyle, font: .boldSystemFont(ofSize: 12), color: .black)) }
    set { set(.bulletinTitleStyle, to: newValue) }
  }
  public var bulletinMessageStyle: FontStyle {
    get { return get(.bulletinMessageStyle, FontStyle(.bulletinMessageStyle, font: .systemFont(ofSize: 12), color: .black)) }
    set { set(.bulletinMessageStyle, to: newValue) }
  }
}
...
extension ConcreteSkin {
  ...
  public mutating func applyDarkDefaults() {
    ...
    bulletinTitleStyle.color = .white
    bulletinMessageStyle.color = .white
