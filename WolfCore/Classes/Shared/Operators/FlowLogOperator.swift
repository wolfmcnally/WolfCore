...
/// The purpose of the FlogLog operator is to print the result of an expression and then return it without requiring it be broken out as a separate variable with a separate identifier and sent to print().
